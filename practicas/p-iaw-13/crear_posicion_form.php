...
<body>
    ...
    <form action="crear_posicion_action.php" method="post">
        Nombre de la posicion: 
        <input type="text" name="nombre_posicion" >
        <?php
            if(isset($_SESSION['insertar_posicion'])){
                echo "<p class='aviso'>".$_SESSION['insertar_posicion']."</p>";
            }
        ?>
