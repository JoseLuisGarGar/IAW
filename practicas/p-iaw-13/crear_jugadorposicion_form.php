...
<body>
    <h1>INSERTAR DATOS JUGADOR Y POSICION</h1>
    <form action="crear_jugador_action.php" method="post">
        ...
        ?>
        Número de la posicion: 
        <input type="number" name="posicion_id" >
        <?php
            if(isset($_SESSION['insertar_posicion_id'])){
                echo "<p class='aviso'>".$_SESSION['insertar_posicion_id']."</p>";
            }
        ?>
